...
const MuiCardHeader: Components<Theme>['MuiCardHeader'] = {
  defaultProps: {
    // Cast to any to allow specifying typography props for title/subheader
    // as some MUI typings may not include these specific props in this setup.
    titleTypographyProps: { variant: 'h6' } as any,
    subheaderTypographyProps: { variant: 'body2' } as any,
  } as any,
  styleOverrides: {
    root: ({ theme }) => ({
